...
function SecurityTab() {
  ...
  const submitChangePassword = (data) => {
    confirmChangePassword({
      // Title, Description, Content...etc of the material-ui-confirm package all have type ReactNode so you can freely use MUI components, very convenient when you need custom styles
      ...
      toast.promise(dispatch(updateUserAPI({ current_password, new_password })), {
        ...
        // Check if there is no error: update successfully
        if (!res.error) {
