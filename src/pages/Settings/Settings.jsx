...
// Declare the stack of tabs as a const variable for reuse.
const TABS = {
  ACCOUNT: 'account',
  SECURITY: 'security'
}
...
function Settings() {
  ...
  // Simple function that gets the default tab based on the url.
  const getDefaultTab = () => {
    if (location.pathname.includes(TABS.SECURITY)) return TABS.SECURITY
    return TABS.ACCOUNT
  }
  // State stores the value of which tab is active
